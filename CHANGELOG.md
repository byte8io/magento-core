...
> **Vendor migration note:** This package is the Byte8 successor to
> `softcommerce/module-core`. Versioning is continuous: the line below picks up
> from `2.4.1` and the breaking `3.0.0` release marks the SoftCommerce → Byte8
> rebrand. Releases up to and including `2.4.1` were published under
> `softcommerceltd/magento-core`; their compare links point there.

## [Unreleased]

## [3.0.0] - 2026-06-13
### BREAKING CHANGES
- Rebrand SoftCommerce → Byte8: Composer vendor moved to `byte8/*`, PHP namespace root moved to `Byte8\`
- Consolidate finer-grained modules into `module-core` / `module-plenty-core` as part of the rebrand
### Added
- add shared activation gate and flip license to MIT
### Changed
- remove deprecated `MessageStorage` and consolidate models into `plenty-core`
...
[Unreleased]: https://github.com/byte8io/magento-core/compare/v3.0.0...HEAD
[3.0.0]: https://github.com/byte8io/magento-core/releases/tag/v3.0.0
